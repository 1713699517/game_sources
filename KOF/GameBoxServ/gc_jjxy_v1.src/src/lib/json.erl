...
-export([mime_type/0, encode/1, decode/1,
		 encode_noauto/1, encode_noauto/2, decode_noauto/1,
		 unicode_decode/1, unicode_encode/1,
		 from_record/3, to_record/3,
		 hex_digit/1, digit_hex/1,
		 get_field/2, get_field/3, set_field/3,
		 equiv/2]).
