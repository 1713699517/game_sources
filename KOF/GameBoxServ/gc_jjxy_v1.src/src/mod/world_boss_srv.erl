...
-export([boss_harm_updata_cast/7]).
%% 以下系统默认函数(勿删)
...
do_cast({boss_harm_updata_cast,MapId,SPid,Uid,Lv,Name,Pro,WarB},State)->
	?MSG_ECHO("======== ~w~n",[State]),
	world_boss_api:boss_harm_updata_cast_handle(MapId,SPid,Uid,Lv,Name,Pro,WarB),
	{?noreply,State};
...
boss_harm_updata_cast(MapId,SPid,Uid,Lv,Name,Pro,WarB)->
	gen_server:cast(?MODULE, {boss_harm_updata_cast,MapId,SPid,Uid,Lv,Name,Pro,WarB}).
