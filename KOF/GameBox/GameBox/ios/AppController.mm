...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [RootViewController setInstance: viewController];
...
-(void) playVideo:(NSString*) name{
    ...
    {
        CCLOG("no first Game Come VideoShow!!!!");
        [CCVideoPlayer playMovieWithFile:name canJump:true];
    }
    else
    {
        CCLOG("first Game Come VideoShow!!!!");
        [CCVideoPlayer playMovieWithFile:name canJump:false];
    }
...
-(void) moviePlaybackFinished{
    CCLOG("jentan----moviePlaybackFinished");
    //视频播放完毕
...
-(void) movieStartsPlaying{
    //视频开始播放
    CCLOG("jentan----movieStartsPlaying");
}
