...
void COPPO_Recharge::initParameter()
{
    //可选金额
...
void COPPO_Recharge::initView()
{
    ...
    mainContainer->setControlName("this COPPO_Recharge mainContainer 111");
    ...
    m_pCloseButton->setControlName("this COPPO_Recharge m_pCloseButton");
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(COPPO_Recharge::closeButtononBeganTouch));
    mainContainer->addChild(m_pCloseButton);
    
    //标题:充值中心
    CSprite *pTitle = CSprite::createWithSpriteFrameName("recharge_word_czzx.png");
    pTitle->setControlName("this COPPO_Recharge pTitle 65");
    ...
    pGongGao->setControlName("this COPPO_Recharge pGongGao 65");
    ...
    pGongGaoTitle->setControlName("this COPPO_Recharge pGongGaoTitle 65");
    ...
    pMainBg->setControlName("this COPPO_Recharge pMainBg 65");
    ...
    pRechaeTitle1->setControlName("this COPPO_Recharge pRechaeTitle1 65");
    ...
    pLineImg->setControlName("this COPPO_Recharge pLineImg 65");
    ...
    pRechaeTitle2->setControlName("this COPPO_Recharge pRechaeTitle2 65");
    ...
    m_pRechargeBtn->setControlName("this COPPO_Recharge m_pRechargeBtn");
    CCSize rechargeBtnSize = m_pRechargeBtn->getPreferredSize();
    m_pRechargeBtn->setPosition(ccp( pos_X+490,108));
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(COPPO_Recharge::rechargeButtononBeganTouch));
...
CButton *COPPO_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setControlName("this COPPO_Recharge button 250");
    button->setPreferredSize( pCellSize );
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(COPPO_Recharge::selectMoneyBeganTouch));
    
    //背景圈圈
    CSprite *rideoBg = CSprite::createWithSpriteFrameName("recharge_underframe_nomal.png");
    rideoBg->setControlName("this COPPO_Recharge createItem rideo 194");
    ...
    rideo->setControlName("this COPPO_Recharge createItem rideo 194");
...
void COPPO_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void COPPO_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void COPPO_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void COPPO_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
    ...
    //oppo充值接口调用
     ...
     if ( JniHelper::getStaticMethodInfo(minfo,"com/haowan123/kof/oppo/nearme/gamecenter/GameBox", "recharge","(ILjava/lang/String;)V") )
     {
     jint money      = _money;
     ...
     {
     CCLOG("COPPO_Recharge::getNetworkStatus method missed!");
     }
