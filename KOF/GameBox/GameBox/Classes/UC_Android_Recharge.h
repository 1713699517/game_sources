...
#ifndef __GameBox__UC_Android_Recharge__
#define __GameBox__UC_Android_Recharge__
...
class CUC_Recharge : public CCNode
{
public:
    CUC_Recharge();
    
    CREATE_FUNC(CUC_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox__MI_Recharge__) */
