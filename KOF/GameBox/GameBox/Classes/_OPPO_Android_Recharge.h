...
#ifndef __GameBox___OPPO_Android_Recharge__
#define __GameBox___OPPO_Android_Recharge__
...
class COPPO_Recharge : public CCNode
{
public:
    COPPO_Recharge();
    
    CREATE_FUNC(COPPO_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox___OPPO_Android_Recharge__) */
