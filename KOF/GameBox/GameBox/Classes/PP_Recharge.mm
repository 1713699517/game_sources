...
void CPP_Recharge::initParameter()
{
    //可选金额
...
void CPP_Recharge::initView()
{
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(CPP_Recharge::closeButtononBeganTouch));
...
//    }
    ...
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(CPP_Recharge::rechargeButtononBeganTouch));
...
CButton *CPP_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(CPP_Recharge::selectMoneyBeganTouch));
...
void CPP_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void CPP_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CPP_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CPP_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
//    CPP_IOS_Recharge *pNode = CPP_IOS_Recharge::create();
//    if (pNode != NULL)
//    {
//        pNode->setPrice(_money);
//        addChild(pNode);
//    }
    ...
    char cpInfo[256];
    strcpy(cpInfo, serverid);
    strcat(cpInfo, "-");
    strcat(cpInfo, roleid);
     */
    /*
    JniMethodInfo minfo;//定义Jni函数信息结构体 
    if ( JniHelper::getStaticMethodInfo(minfo,"com/haowan123/kof/mi/GameBox", "recharge","(ILjava/lang/String;)V") )
    {
        jint money      = _money;
    ...
    {
        CCLOG("CPP_Recharge::getNetworkStatus method missed!");
    }
