...
void CMI_Recharge::initParameter()
{
    //可选金额
...
void CMI_Recharge::initView()
{
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(CMI_Recharge::closeButtononBeganTouch));
    ...
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(CMI_Recharge::rechargeButtononBeganTouch));
...
CButton *CMI_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(CMI_Recharge::selectMoneyBeganTouch));
...
void CMI_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void CMI_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CMI_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CMI_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
//    string _money_str = m_pEditBox->getTextString();   //atoi(_money_str.c_str());
    ...
    {
        CCLOG("CMI_Recharge::getNetworkStatus method missed!");
    }
