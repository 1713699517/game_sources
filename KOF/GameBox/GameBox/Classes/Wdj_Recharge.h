...
#ifndef __GameBox__Wdj_Recharge__
#define __GameBox__Wdj_Recharge__
...
class CWdj_Recharge : public CCNode
{
public:
    CWdj_Recharge();
    
    CREATE_FUNC(CWdj_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox__Wdj_Recharge__) */
