...
void CUC_Recharge::initParameter()
{
    //可选金额
...
void CUC_Recharge::initView()
{
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(CUC_Recharge::closeButtononBeganTouch));
    ...
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(CUC_Recharge::rechargeButtononBeganTouch));
...
CButton *CUC_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(CUC_Recharge::selectMoneyBeganTouch));
...
void CUC_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void CUC_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CUC_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CUC_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
    ...
    if ( JniHelper::getStaticMethodInfo(minfo,"com/haowan123/kof/uc/GameBox", "recharge","(ILjava/lang/String;)V") )
    {
        jint money      = _money;
    ...
    {
        CCLOG("CUC_Recharge::getNetworkStatus method missed!");
    }
