...
CBaidu_Recharge::CBaidu_Recharge()
:m_phightImg(NULL)
,m_pselectImg(NULL)
...
void CBaidu_Recharge::initParameter()
{
    //可选金额
...
void CBaidu_Recharge::initView()
{
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(CBaidu_Recharge::closeButtononBeganTouch));
    ...
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(CBaidu_Recharge::rechargeButtononBeganTouch));
...
CButton *CBaidu_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(CBaidu_Recharge::selectMoneyBeganTouch));
...
void CBaidu_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void CBaidu_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CBaidu_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void CBaidu_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
//    strcat(cpInfo, payid);
    CCLOG("###########cpInfo=%s",cpInfo);
    
    JniMethodInfo minfo;//定义Jni函数信息结构体
    if ( JniHelper::getStaticMethodInfo(minfo,"com/haowan123/kof/bd/GameBox", "applyRecharge","(ILjava/lang/String;)V") )
    {
        jint money      = _money;
    ...
    {
        CCLOG("CBaidu_Recharge::getNetworkStatus method missed!");
    }
