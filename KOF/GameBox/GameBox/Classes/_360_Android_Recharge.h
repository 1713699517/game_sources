...
#ifndef __GameBox__360_Android_Recharge__
#define __GameBox__360_Android_Recharge__
...
class C360_Android_Recharge : public CCNode
{
public:
    C360_Android_Recharge();
    
    CREATE_FUNC(C360_Android_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox__360_Android_Recharge__) */
