...
C91Android_Recharge::C91Android_Recharge()
:m_phightImg(NULL)
,m_pselectImg(NULL)
...
bool C91Android_Recharge::init()
{
    if( !CCNode::init() )
        return false;
    
    CCLOG("C91Android_Recharge::init()");
...
void C91Android_Recharge::initParameter()
{
    //可选金额
...
void C91Android_Recharge::initView()
{
    ...
    m_pCloseButton->addEventListener("TouchBegan", this, eventhandler_selector(C91Android_Recharge::closeButtononBeganTouch));
    ...
    m_pRechargeBtn->addEventListener("TouchBegan", this, eventhandler_selector(C91Android_Recharge::rechargeButtononBeganTouch));
...
CButton *C91Android_Recharge::createItem( int money )
{
    char str_money[100];
    ...
    button->setTag(money);
    button->addEventListener("TouchBegan", this, eventhandler_selector(C91Android_Recharge::selectMoneyBeganTouch));
...
void C91Android_Recharge::setHightLight( CButton *obj )
{
    //设置选中项的背景高亮效果
    if( m_phightImg != NULL )
    {
...
void C91Android_Recharge::selectMoneyBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void C91Android_Recharge::closeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
void C91Android_Recharge::rechargeButtononBeganTouch(cocos2d::CCObject *pSender, ptola::event::CEvent *pEvent)
{
...
//    string _money_str = m_pEditBox->getTextString();   //atoi(_money_str.c_str());
    ...
    if ( JniHelper::getStaticMethodInfo(minfo,"com/haowan123/kof/nd/GameBox", "recharge","(ILjava/lang/String;)V") )
    {
        jint money      = _money;
    ...
    {
        CCLOG("C91Android_Recharge::getNetworkStatus method missed!");
    }
