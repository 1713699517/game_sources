...
#ifndef __GameBox__PP_Recharge__
#define __GameBox__PP_Recharge__
...
class CPP_Recharge : public CCNode
{
public:
    CPP_Recharge();
    
    CREATE_FUNC(CPP_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox__PP_Recharge__) */
