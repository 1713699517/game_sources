...
#ifndef __GameBox__91_Android_Recharge__
#define __GameBox__91_Android_Recharge__
...
class C91Android_Recharge : public CCNode
{
public:
    C91Android_Recharge();
    
    CREATE_FUNC(C91Android_Recharge);
    bool init();
    void loadResources();
...
#endif /* defined(__GameBox__91_Android_Recharge__) */
